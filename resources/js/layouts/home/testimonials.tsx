    ...
    return (
        <div className="mt-30 h-auto w-full font-hanken">
            <header className="w-[90%] text-left font-playfair text-3xl font-bold text-dark md:text-4xl lg:text-5xl">
                ...
                <span className='bg-primary px-2 text-neutral italic'>Burgerin</span> ?
            </header>
            <div className="hide-scrollbar flex w-full items-stretch gap-8 overflow-x-auto pb-10 md:gap-12">
                {testimonialConst.map((item) => (
                    <div
                        className="flex h-auto w-75 shrink-0 snap-center"
                        key={item.id}
                    >
                        <CardTestimonial
